...
open class DefaultFakeHistoryRepository : HistoryRepository {
    ...
    override suspend fun deleteEditingHistory(historyId: String): Unit = throw NotImplementedError()
    ...
    override suspend fun deleteEditingElement(elementId: String): Unit = throw NotImplementedError()
    override suspend fun updateHistoryTitle(historyId: String, newTitle: String): Unit = throw NotImplementedError()
    override suspend fun updateHistoryElement(historyElement: HistoryElement): Unit = throw NotImplementedError()
    override suspend fun updateHistoryDateRange(historyId: String, newDateRange: LocalDateRange): Unit = throw NotImplementedError()
    override suspend fun swapElements(historyId: String, fromId: String, toId: String): Unit = throw NotImplementedError()
