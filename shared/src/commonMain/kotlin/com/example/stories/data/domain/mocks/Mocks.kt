...
class Mocks {
    ...
    fun getMockStories() = listOf(
        History(
            ...
            dateRange = LocalDate.now().add(monthNumber = -2) to null,
        ...
        History(
            ...
            dateRange = LocalDate.now().add(monthNumber = -1) to null,
        ...
        History(
            ...
            dateRange = LocalDate.now().add(dayOfMonth = -7) to LocalDate.now(),
