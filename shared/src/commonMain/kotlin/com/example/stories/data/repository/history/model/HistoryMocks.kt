...
class HistoryMocks {
    ...
    fun getHistoryElementText() = HistoryElement.Text(id = getNewId(), text = "Monté a caballo en el mar de arena que rodea al volcán activo Bromo, en el este de Java.")
    fun getHistoryElementImage() = HistoryElement.Image(id = getNewId(), imageResource = "https://www.elperiodicodelturismo.com/images/crater-monte-bromo.webp")
